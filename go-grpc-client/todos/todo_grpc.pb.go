...
type TodoClient interface {
	CreateTodo(ctx context.Context, in *TodoText, opts ...grpc.CallOption) (*TodoItem, error)
...
func (c *todoClient) CreateTodo(ctx context.Context, in *TodoText, opts ...grpc.CallOption) (*TodoItem, error) {
	out := new(TodoItem)
...
type TodoServer interface {
	CreateTodo(context.Context, *TodoText) (*TodoItem, error)
...
func (UnimplementedTodoServer) CreateTodo(context.Context, *TodoText) (*TodoItem, error) {
...
func _Todo_CreateTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServer).CreateTodo(ctx, req.(*TodoText))
	}
